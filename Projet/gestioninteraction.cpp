...
/**
 * @brief GestionInteraction::getLastSavedInteraction Cette fonction retourne la dernière intéraction enregistrée dans la liste
 * @return la dernière intéraction
 */
Interaction * GestionInteraction::getLastSavedInteraction()
{
    return &(*(--listInteraction.end()));
}

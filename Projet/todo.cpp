...
/**
    ...
    *@return vrai si la date est correcte sinon retourne faux
    *@warning Si la date à un format incorrect, la date ne change pas;
*/
bool Todo::setDateFromString(const QString& t)
{
    if(QDate::fromString(t, "dd/MM/yyyy").isValid())
    {

...
public:
    ...
    std::list<Contact>* getListContactAdr() { return &listContact;}
    ...
    GestionTodo* getGestTodo() const{ return gestTodo;}
        ...
        /// Récuperer le contact à la position donnée
        Contact getContactAt(const int);
        /// Récupérer l'adresse du contact dans la liste
        Contact* getContactAdr(const QString&);
